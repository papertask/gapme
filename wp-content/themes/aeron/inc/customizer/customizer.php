	...
	**/
	$wp_customize->add_section('section_general', array(
		...
		**/
		...
		$wp_customize->add_control(new Toggle_Checkbox_Custom_control($wp_customize, 'fixed_header', array(
			'label'    => esc_html__('Sticky Header', 'ABdev_aeron'),
			'description'   => esc_attr__('Check if you want the header to be always on top.', 'ABdev_aeron'),
			'type'     => 'checkbox',
			'section'  => 'section_general',
		)));
	...
	$wp_customize->add_section('section_global_colors', array(
		...
		**/
		...
		$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'main_color', array(
			'label'      => esc_html__('Main Color, Headings', 'ABdev_aeron'),
			'settings'   => 'main_color',
		...
		**/
		...
		$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'secondary_color', array(
			'label'      => esc_html__('Secondary Color, Links', 'ABdev_aeron'),
			'settings'   => 'secondary_color',
			'section'    => 'section_global_colors',
		)));

		/**
		Light Color, Dividers, Strokes
		**/
		...
		$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'light_color', array(
			'label'      => esc_html__('Light Color, Dividers, Strokes', 'ABdev_aeron'),
		...
		**/
		...
		$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'section_bg_color', array(
			'label'      => esc_html__('Section Background, Dividers, Strokes', 'ABdev_aeron'),
		...
		**/
		...
		$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'body_text', array(
			'label'      => esc_html__('Body Text', 'ABdev_aeron'),
			'settings'   => 'body_text',
			'section'    => 'section_global_colors',
		)));
		...
		**/
		...
		Sep 2
		**/
		$wp_customize->add_setting('general_sep_2', array(
			'default'     => '',
			'sanitize_callback' => 'esc_html',
		));
		$wp_customize->add_control(new Separator_Custom_control($wp_customize, 'general_sep_2', array(
			'settings'  	=> 'general_sep_2',
			'section'   	=> 'section_global_colors',
		)));
