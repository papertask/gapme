...
function ABdev_aeron_single_event_links() {
	...
	echo '<a class="tribe-events-gcal tribe-events-button" href="' . Tribe__Events__Main::instance()->esc_gcal_url( tribe_get_gcal_link() ) . '" title="' . esc_attr__( 'Add to Google Calendar', 'ABdev_aeron' ) . '">' . esc_html__( 'Google Calendar', 'ABdev_aeron' ) . '<i class="gm-redo"></i></a>';
	echo '<a class="tribe-events-ical tribe-events-button" href="' . esc_url( tribe_get_single_ical_link() ) . '" title="' . esc_attr__( 'Download .ics file', 'ABdev_aeron' ) . '" >' . esc_html__( 'iCal Export', 'ABdev_aeron' ) . '<i class="gm-redo"></i></a>';
