...
<?php echo (get_theme_mod('boxed_body', false)) ? '<div class="boxed_body_wrapper">' : ''; ?>
	...
	<header id="aeron_header" class="<?php echo (!empty($ABdev_sticky_header)) ? 'ABdev_on_sticky_header' : ''; ?><?php echo (get_theme_mod( 'show_announcement_bar', false))? ' with_topbar' : '';?><?php echo (get_theme_mod( 'fixed_header', false))? ' fixed_header' : '';?>">
