...
$tcvpb_elements['table_tc'] = array(
	'name' => esc_html__('Table', 'ABdev_dzen' ),
	'type' => 'block',
	'icon' => 'pi-table',
	...
	'attributes' => array(
		...
		'alternative_style' => array(
			'default' => '0',
			'description' => esc_html__('Alternative Styling', 'ABdev_dzen'),
			'type' => 'checkbox',
			'tab' => esc_html__('Style', 'ABdev_dzen'),
		),
		'hover' => array(
			'default' => '0',
			'description' => esc_html__('Rows with Hover', 'ABdev_dzen'),
			'type' => 'checkbox',
			'tab' => esc_html__('Style', 'ABdev_dzen'),
		),
		'striped' => array(
			'default' => '0',
			'description' => esc_html__('Striped Rows', 'ABdev_dzen'),
			'type' => 'checkbox',
			'tab' => esc_html__('Style', 'ABdev_dzen'),
		),
		'condensed' => array(
			'default' => '0',
			'description' => esc_html__('Condensed Table', 'ABdev_dzen'),
			'type' => 'checkbox',
			'tab' => esc_html__('Style', 'ABdev_dzen'),
		),
		'id' => array(
