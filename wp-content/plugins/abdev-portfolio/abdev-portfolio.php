...
function ABp_portfolio_register() {  
    ...
    $args = array(  
        'label' => __('Portfolio', THEME_TRANSLATE_DOMAIN),  
        'labels' => array(  
			'add_new_item' => __('New portfolio', THEME_TRANSLATE_DOMAIN),  
			'new_item' => __('New portfolio', THEME_TRANSLATE_DOMAIN),  
			'not_found' => __('No portfolio items', THEME_TRANSLATE_DOMAIN),  
		),  
        'singular_label' => __('Portfolio', THEME_TRANSLATE_DOMAIN),  
        'public' => true,  
